...
3. **Rectify.** Identify the four board corners in the screenshot as pixel coordinates in the order top-left, top-right, bottom-right, bottom-left of the draft's frame. Confirm each estimate on a 200×200 crop around it (`magick in.png -crop 200x200+X+Y +repage corner.png`). Map the board to 20 px per inch on the 60×44 board:
