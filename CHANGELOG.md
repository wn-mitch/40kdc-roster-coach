...
- Add the repository-scoped Codex coaching skill and private workspace.
- Pin 40kdc entity, roster, export, and expected-value damage helpers.
- Add version-aware local ability-text lookup with content hashes.
